...
<div class="wrapper">
    ...
    <!--菜单回显-->
    <c:set var="currentMenu" value="customer_potential"/>
...
<c:forEach items="${result.list}" var="c" varStatus="vs">
...
<tr>
                                ...
                                <td>${c.statusStr}</td>
                                <%--<td>${c.input_time}</td>--%>
    <td><fmt:formatDate value="${c.input_time}" pattern="yyyy-MM-dd"/></td>
                            </tr>
</c:forEach>
