            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li name="customer_formal"><a href="/customer/list?status=1"><i class="fa fa-circle-o"></i> 正式客户</a></li>
                    <li name="customer_loss"><a href="/customer/list?status=4"><i class="fa fa-circle-o"></i> 流失客户</a></li>
                </ul>
            </li>
            <%--<li class="treeview">--%>
                <%--<a href="#">--%>
